          ...
          {divisions.map((division, index) => (
            ...
            >
              <div className="grid md:grid-cols-[1.02fr_0.98fr] md:items-stretch">
                <Link
                  to={division.to}
                  className="relative min-h-[11.5rem] overflow-hidden cursor-pointer md:h-full"
                >
                  <img
                    src={division.image}
                    alt={division.title}
                ...
                <div
                  className={`flex h-full flex-col bg-[linear-gradient(155deg,rgba(255,255,255,0.02),rgba(255,255,255,0.01))] p-4.5 md:p-5`}
                >
